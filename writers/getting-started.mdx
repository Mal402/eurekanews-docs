...
- You'll receive an email notification when your application is approved or rejected
  ...
  <img
    src="/images/email-notification-acceptance-eureka-news-.png"
    alt="email-notification-acceptance-eureka-news-.png"
    title="email-notification-acceptance-eureka-news-.png"
    style={{ width:"74%" }}
  />
